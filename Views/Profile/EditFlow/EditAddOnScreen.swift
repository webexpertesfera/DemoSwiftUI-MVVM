                        ...
                        if AppUtil.selectedCategory != "Stadium" {
                            if AppUtil.selectedCategory == "Hotel" || AppUtil.selectedCategory == "Hotels" {
                               ...
                               // if WeddingArrangements != "" {
                                    AppUtil.editserviceObject?.addOns = addOnsobj
                                    serviceManager.editserviceObject?.addOns = addOnsobj
                                    
                                    viewRouter.currentPage = "EditReviewService"
//                                } else {
//                                    togglepopup.toggle()
//                                }
...
struct EditAddOnScreen_Previews: PreviewProvider {
