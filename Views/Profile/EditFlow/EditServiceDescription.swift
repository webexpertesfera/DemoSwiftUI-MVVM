...
struct EditServiceDescription: View {
    @State private var keyboardHeight: CGFloat = 0
    @State private var offsetValue: CGFloat = 0.0
    @EnvironmentObject var viewRouter: ViewRouter
    @EnvironmentObject var serviceManager: ServiceManager
    @State var serviceNameEnglish: String = AppUtil.editserviceObject?.description?.nameInEnglish ?? ""
    @State var serviceNameArabic: String = AppUtil.editserviceObject?.description?.nameInArabic ?? ""
    @State var phonenumber: String = AppUtil.validateVariable(AppUtil.editserviceObject?.description?.secondryPhone ?? 0)
    @State var area: String = AppUtil.validateVariable(AppUtil.editserviceObject?.description?.areaSqm ?? 0)
   
    @State var descriptionEnglish: String = AppUtil.editserviceObject?.description?.descriptionInEnglish ?? ""
    @State var descriptionArabic: String = AppUtil.editserviceObject?.description?.descriptionInArabic ?? ""
...
//                                        if showText { //only show the text if showText == true
                        ...
                        LoginButton(title: "Next", callback: {
                            ...
                            AppUtil.pickerResult = pickerResult
                            AppUtil.editserviceObject?.description?.areaSqm = Int(area)
                            AppUtil.editserviceObject?.description?.nameInArabic = serviceNameArabic
                            AppUtil.editserviceObject?.description?.nameInEnglish = serviceNameEnglish
                            AppUtil.editserviceObject?.description?.secondryPhone = Int(phonenumber)
//                            AppUtil.addserviceObject?.description?.secondryPhone = phonenumber

                            AppUtil.editserviceObject?.description?.descriptionInEnglish = descriptionEnglish
                            AppUtil.editserviceObject?.description?.descriptionInArabic = descriptionArabic
                            ...
                            if serviceNameEnglish != "" && descriptionEnglish != "" && phonenumber != "" {
                                ...
                                if pickerResult.count > 4 {
                                    AppUtil.pickerResult = pickerResult
                                    viewRouter.currentPage = "EditServiceLocation"
                                } else {
                                   imagecount.toggle()
                                }
                            } else {
...
struct EditServiceDescription_Previews: PreviewProvider {
