//
//  DistanceScreen.swift
//  SmartBookings
//
//  Created by Esfera-Macmini on 16/03/23.
//

import SwiftUI

struct DistanceScreen: View {
@EnvironmentObject var viewRouter: ViewRouter
@State var minPrice: Float = 25
@State var ArbCheck: Bool = false
@State var EngCheck: Bool = false
@State var notificationCheck: Bool = AppUtil.appSettings.notification ?? false
var body: some View {
    ZStack{
        VStack{
...
//                        setObj.language = ArbCheck ? "Arabic" : "English"
...
//            }
            ...
            minPrice = Float(AppUtil.appSettings.distance?.maxDistance ?? 0)
        })
        
}
}

struct DistanceScreen_preview: PreviewProvider {
