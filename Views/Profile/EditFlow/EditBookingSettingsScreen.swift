//
//  EditBookingSettingsScreen.swift
//  SmartBookings
//
...
struct EditBookingSettingsScreen: View {
    
    @EnvironmentObject var viewRouter: ViewRouter
    @EnvironmentObject var serviceManager: ServiceManager
    @State var togglepopup: Bool = false
    @State var bookingFor: String = AppUtil.editserviceObject?.bookingSetting?.bookingFor ?? ""
    @State var securityDeposit: Bool = AppUtil.editserviceObject?.bookingSetting?.securityDeposit ?? false
    @State var lastMinuteDeposit: Bool = AppUtil.editserviceObject?.bookingSetting?.lastMinuteDiscount ?? false
    @State var securityDepositAmount: String = ""
    @State var days: String = AppUtil.validateVariable(AppUtil.editserviceObject?.bookingSetting?.days ?? 0)
    @State var percentage: String = AppUtil.validateVariable(AppUtil.editserviceObject?.bookingSetting?.discountPercentage ?? 0)
    var body: some View {
        ZStack{
            VStack{
                ...
                ScrollView(showsIndicators:false){
                        ...
                        RoundedRectangle(cornerRadius: 10)
                            ...
                            .overlay(
                                VStack{
                                    ...
                                    AppUtil.editserviceObject?.bookingSetting?.bookingFor = bookingFor
                                }
                            )
                    ...
                    VStack{
                        RoundedRectangle(cornerRadius: 8)
                            ...
                            .overlay(
                                ...
                                viewRouter.currentPage = "EditBookingTypes"
                            }
                        ...
                        RoundedRectangle(cornerRadius: 8)
                            ...
                            .overlay(
                                ...
                                viewRouter.currentPage = "EditCancellationPolicyScreen"
                            }
                    ...
                    LoginButton(title: "Next", callback: {
                        ...
                        if serviceManager.selectedCancellationType != "" && serviceManager.selectedBookingType != ""  {
                            ...
                            if  AppUtil.editserviceObject?.bookingSetting?.bookingFor != "" {
                                viewRouter.currentPage = "EditAddOnScreen"
                            } else {
                                togglepopup.toggle()
                            }
                        } else {
            ...
            .onAppear(perform: {
                ...
                if AppUtil.editserviceObject?.bookingSetting?.bookingFor != nil {
                    bookingFor = AppUtil.editserviceObject?.bookingSetting?.bookingFor ?? ""
                } else {
                  bookingFor =  serviceBookingFor.Families_and_Singles.rawValue
                }
                               
                securityDepositAmount = String(AppUtil.editserviceObject?.bookingSetting?.securityAmount ?? 0)
                securityDeposit = AppUtil.editserviceObject?.bookingSetting?.securityDeposit ?? false
                lastMinuteDeposit =  AppUtil.editserviceObject?.bookingSetting?.lastMinuteDiscount ?? false
...
struct EditBookingSettingsScreen_Previews: PreviewProvider {
    static var previews: some View {
        EditBookingSettingsScreen()
    }
}
