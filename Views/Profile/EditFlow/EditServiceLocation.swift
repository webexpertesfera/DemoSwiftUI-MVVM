...
struct EditServiceLocation: View {
    
    @EnvironmentObject var viewRouter: ViewRouter
    @State var address: String = AppUtil.editserviceObject?.address?.address ?? ""
    @State var Property: String = AppUtil.editserviceObject?.address?.houseNumber ?? ""
    @State var City: String = AppUtil.editserviceObject?.address?.city ?? ""
    @State var Area: String = AppUtil.editserviceObject?.address?.area ?? ""
    @State var Landmark: String = AppUtil.editserviceObject?.address?.landMark ?? ""
    @State var destination: String = AppUtil.editserviceObject?.address?.destination ?? ""
    @State var district: String = AppUtil.editserviceObject?.address?.district ?? ""
    @State var direction: String = AppUtil.editserviceObject?.address?.direction ?? ""
...
struct EditServiceLocation_Previews: PreviewProvider {
