...
struct BasicInfoDetail: View {
    ...
    @State var section: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.section ?? 0)
    @State var doubleBed: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.doubleBed ?? 0)
    @State var singleBed: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.singleBed ?? 0)
    @State var bathrooms: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.bathrooms ?? 0)
    @State var maxGuest: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.maxGuest ?? 0)
    ...
    @State var numOfUnits: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.numberOfUnits ?? 0)
    @State var numOfChildrens: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.numberOfChild ?? 0)
  
    @State var bedrooms: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.bedrooms ?? 0)
    @State var stands: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.stands ?? 0)
    @State var dressingRooms: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.dressingRooms ?? 0)
    @State var maleRooms: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.maleRooms ?? 0)
    @State var femaleRooms: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.femaleRooms ?? 0)
    @State var maxSittingCapacity: String = AppUtil.validateVariable(AppUtil.addserviceObject?.roomsGuest?.maxSittingCapacity ?? 0)
    ...
    @State var indoorSeating: Bool = AppUtil.addserviceObject?.roomsGuest?.indoorSeating ?? false
    @State var outdoorSeating: Bool = AppUtil.addserviceObject?.roomsGuest?.outdoorSeating ?? false
    @State var additionalSeating: Bool = AppUtil.addserviceObject?.roomsGuest?.additionSeating ?? false
    @State var roomType: String = AppUtil.addserviceObject?.roomsGuest?.roomType ?? ""
    
//    MARK: - Hotel, camps
    @State var hotelroomType: String = AppUtil.addserviceObject?.unitsAndGuest?.roomType ?? ""
    ...
    @State var numberChildren: String = AppUtil.validateVariable(AppUtil.addserviceObject?.unitsAndGuest?.numberChildren ?? 0)
    @State var hotelsingleBed: String = AppUtil.validateVariable(AppUtil.addserviceObject?.unitsAndGuest?.singleBed ?? 0)
    @State var hoteldoubleBed: String = AppUtil.validateVariable(AppUtil.addserviceObject?.unitsAndGuest?.doubleBed ?? 0)
    @State var hotelmaxguest: String = AppUtil.validateVariable(AppUtil.addserviceObject?.unitsAndGuest?.maxGuest ?? 0)
    @State var hotelbathrooms: String = AppUtil.validateVariable(AppUtil.addserviceObject?.unitsAndGuest?.bathrooms ?? 0)
    @State var hotelsection: String = AppUtil.validateVariable(AppUtil.addserviceObject?.unitsAndGuest?.section ?? 0)
    
    @State var hotelindoorSeating: Bool = AppUtil.addserviceObject?.unitsAndGuest?.indoorSeating ?? false
    @State var hoteloutdoorSeating: Bool = AppUtil.addserviceObject?.unitsAndGuest?.outdoorSeating ?? false
    @State var hoteladditionalSeating: Bool = AppUtil.addserviceObject?.unitsAndGuest?.additionSeating ?? false
...
//                                          unitsAndGuest.numberUnits != 0 &&
                                            ...
                                            if unitsAndGuest.bathrooms != 0 &&  unitsAndGuest.singleBed != 0 &&  unitsAndGuest.roomType != "" &&  unitsAndGuest.numberChildren != 0 && unitsAndGuest.numberAdults != 0 {
                                                ...
                                                viewRouter.currentPage = "AmenitiesScreen"
                                            } else {
                                                togglepopup.toggle()
                                            }
